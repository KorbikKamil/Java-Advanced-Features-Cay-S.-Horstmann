...
/**
 * Program wykonujący kilka złożonych zapytań wykonywanych na bazie danych.
 *
...
public class QueryDB {
     ...
     * @param conn połączenie z bazą danych
     */
    public static void changePrice(Connection conn) throws SQLException {
     ...
     * @return opcja wybrana przez użytkownika
     */
